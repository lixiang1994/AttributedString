...
class HighlightedViewController: ViewController<HighlightedView> {
    ...
    override func viewDidLoad() {
        ...
        do {
            var string: AttributedString = "我的名字叫李响，我的手机号码是\(18611401994, .action { print("aaa") })，我的电子邮件地址是18611401994@163.com，现在是2020/06/28 20:30。我的GitHub主页是https://github.com/lixiang1994。"
            string.highlighted([.address], [.foreground(#colorLiteral(red: 0.9529411793, green: 0.6862745285, blue: 0.1333333403, alpha: 1)), .font(.systemFont(ofSize: 20, weight: .medium))])
            string.highlighted([.link], [.foreground(#colorLiteral(red: 0.4666666687, green: 0.7647058964, blue: 0.2666666806, alpha: 1)), .font(.systemFont(ofSize: 20, weight: .medium))])
            string.highlighted([.date], [.foreground(#colorLiteral(red: 0.1764705926, green: 0.01176470611, blue: 0.5607843399, alpha: 1)), .font(.systemFont(ofSize: 20, weight: .medium))])
        ...
        do {
            ...
            string.highlighted([.address], [.foreground(#colorLiteral(red: 0.9529411793, green: 0.6862745285, blue: 0.1333333403, alpha: 1))])
            string.highlighted([.link], [.foreground(#colorLiteral(red: 0.4666666687, green: 0.7647058964, blue: 0.2666666806, alpha: 1))])
            string.highlighted([.date], [.foreground(#colorLiteral(red: 0.1764705926, green: 0.01176470611, blue: 0.5607843399, alpha: 1))])
...
class HighlightedView: UIView {
    ...
    override func tintColorDidChange() {
        ...
        label.attributed.text?.highlighted([.phoneNumber], [.foreground(color)])
        textView.attributed.text.highlighted([.phoneNumber], [.foreground(color)])
    }
}
